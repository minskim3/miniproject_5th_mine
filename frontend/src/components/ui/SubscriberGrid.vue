    ...
    <v-container>
        ...
        <div class="panel">
            <div class="gs-bundle-of-buttons" style="max-height:10vh;">
                ...
                <v-btn :disabled="!selectedRow" style="margin-left: 5px;" @click="signUp" class="contrast-primary-text" small color="primary" >
                    <v-icon small>mdi-minus-circle-outline</v-icon>signUp
                </v-btn>
                <v-btn :disabled="!selectedRow" style="margin-left: 5px;" @click="monthlyPaid" class="contrast-primary-text" small color="primary" >
