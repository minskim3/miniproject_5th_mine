                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="SummaryContext">{{ val.summaryContext }}</td>
                            <td class="whitespace-nowrap" label="Tag">{{ val.tag }}</td>
        ...
        <v-col>
            ...
            >
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            <Number label="SummaryId" v-model="selectedRow.summaryId" :editMode="true"/>
                            <String label="WritingId" v-model="selectedRow.writingId" :editMode="true"/>
                            <String label="SummaryContext" v-model="selectedRow.summaryContext" :editMode="true"/>
                            <String label="Tag" v-model="selectedRow.tag" :editMode="true"/>
