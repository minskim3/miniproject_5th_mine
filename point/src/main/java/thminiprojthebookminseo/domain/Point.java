...
import lombok.Data;
import thminiprojthebookminseo.PointApplication;
import thminiprojthebookminseo.domain.KtSignedupPointCharged;
import thminiprojthebookminseo.domain.PointDecreased;
import thminiprojthebookminseo.domain.PointInsufficient;
import thminiprojthebookminseo.domain.PointRecharged;
import thminiprojthebookminseo.domain.StandardSignedupPointCharged;
...
public class Point {
    ...
    public static void pointDecrease(BookSubscribed bookSubscribed) {
        ...
        */
        ...
        // if bookSubscribed.subscriberId exists, use it
        
        // ObjectMapper mapper = new ObjectMapper();
        // Map<Long, Object> subscribedBookMap = mapper.convertValue(bookSubscribed.getSubscriberId(), Map.class);
